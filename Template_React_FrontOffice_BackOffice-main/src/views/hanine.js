...
export default function hanine() {
  return (
    <>
      <Navbar transparent />
      <main>
        ...
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://thumbs.dreamstime.com/b/l-%C3%A9l%C3%A8ve-choisit-enseignant-pour-les-classes-profils-de-diff%C3%A9rents-tuteurs-sur-%C3%A9cran-d-ordinateur-homme-le-tuteur-et-la-langue-227810725.jpg')",
            }}
          >
            <span
              id="blackOverlay"
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-5xl">
                   ...
                   "Nos tuteurs passionnés vous accompagnent dans l'apprentissage de la langue de votre choix"
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Michelle Burns</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Hi! I'm Michelle. Language lover and tutor of English
                    </p>
                    <Link to="/auth/login">
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Teacher Colleen</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                    Hi, I am Colleen from northern Wisconsin 
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Ronnie UK</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Hi! I live in the Midlands in the UK
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Sang Kim</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Hi, my name is Sang Kim, and I am a terrific English teacher
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Linda Sch</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     I was a professor for 13 years, and enjoyed motivating students
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Ariella IELTS</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Would you like to improve your speaking and listening skills?
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Maria V Schafer</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                     Hola! My name is Maria, and I'm an spanish Teacher!
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Rey R</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                    A fun loving guy who also speaks fluent Spanish. I love reading
                    </p>
                     <Link to="/auth/login">
                    <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
  <i className="fas fa-heart"></i> </button>
